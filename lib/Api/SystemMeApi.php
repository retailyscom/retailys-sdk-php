...
class SystemMeApi
{
     ...
     * @return \Retailys\Model\MeModel|\Retailys\Model\ErrorModel
     */
     ...
     * @throws \Retailys\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Retailys\Model\MeModel|\Retailys\Model\ErrorModel, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMeWithHttpInfo()
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Retailys\Model\MeModel' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Retailys\Model\MeModel', []),
            ...
            $returnType = '\Retailys\Model\MeModel';
