...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.retailys.com/v1';
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/0.1-beta/PHP';
    ...
    {
        $report  = 'PHP SDK (Retailys) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 1.1.02' . PHP_EOL;
        $report .= '    SDK Package Version: 0.1-beta' . PHP_EOL;
