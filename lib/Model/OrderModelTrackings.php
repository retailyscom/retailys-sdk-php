...
/**
 * OrderModelTrackings Class Doc Comment
 *
 * @category Class
 * @package  Retailys
 * @author   OpenAPI Generator team
 ...
 */
class OrderModelTrackings implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderModel_trackings';
    ...
    {
        $this->container['shipperId'] = $data['shipperId'] ?? null;
        $this->container['trackingNumber'] = $data['trackingNumber'] ?? null;
        $this->container['trackingUrl'] = $data['trackingUrl'] ?? null;
    }
     ...
     * Sets shipperId
     *
     * @param int|null $shipperId shipperId
     *
     * @return self
     */
