...
/**
 * ArticleAddVariantPostRequestVariant1 Class Doc Comment
 *
 * @category Class
 * @description Variant level 1.
 * @package  Retailys
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ArticleAddVariantPostRequestVariant1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ArticleAddVariantPostRequest_variant1';
    ...
    {
        $this->container['variantId'] = $data['variantId'] ?? null;
        $this->container['variantValue'] = $data['variantValue'] ?? null;
    }
     ...
     * Sets variantId
     *
     * @param int|null $variantId variantId
     *
     * @return self
     */
    ...
    {
        return $this->container['variantValue'];
    }

    /**
     * Sets variantValue
     *
     * @param int|null $variantValue variantValue
     *
     * @return self
     */
    public function setVariantValue($variantValue)
    {
        $this->container['variantValue'] = $variantValue;
