 ...
 */
class IdentModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IdentModel';
    ...
    const TYPE_INTERNAL_CATALOGID = 'internal_catalogid';
    const TYPE_MANUFACTURER_CATALOGID = 'manufacturer_catalogid';
    ...
    public function getTypeAllowableValues()
    {
        return [
            ...
            self::TYPE_ISBN,
            self::TYPE_ASIN,
            self::TYPE_INTERNAL_CATALOGID,
            self::TYPE_MANUFACTURER_CATALOGID,
        ];
    }
     ...
     * Sets type
     *
     * @param string|null $type Identifier Type.
     *
     * @return self
     */
