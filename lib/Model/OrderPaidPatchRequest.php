...
/**
 * OrderPaidPatchRequest Class Doc Comment
 *
 * @category Class
 * @package  Retailys
 * @author   OpenAPI Generator team
 ...
 */
class OrderPaidPatchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderPaidPatchRequest';
     ...
     * Sets paid
     *
     * @param float|null $paid Paid value
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string|null $url Payment recovery url
     *
     * @return self
     */
