...
/**
 * StoresProviderModel Class Doc Comment
 *
 * @category Class
 * @package  Retailys
 * @author   OpenAPI Generator team
 ...
 */
class StoresProviderModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StoresProviderModel';
     ...
     * Sets id
     *
     * @param int|null $id Stores Provider Identifier.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Stores Provider name.
     *
     * @return self
     */
