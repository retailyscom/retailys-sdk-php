...
/**
 * PaymentsProviderModel Class Doc Comment
 *
 * @category Class
 * @package  Retailys
 * @author   OpenAPI Generator team
 ...
 */
class PaymentsProviderModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentsProviderModel';
     ...
     * Sets id
     *
     * @param int|null $id Payments Provider Identifier.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Payments Provider name.
     *
     * @return self
     */
