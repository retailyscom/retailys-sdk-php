...
class OrderPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderPostRequest';
     ...
     * Sets channel
     *
     * @param int|null $channel Channel.
     *
     * @return self
     */
     ...
     * Sets ip
     *
     * @param string|null $ip Customer IP adrress.
     *
     * @return self
     */
     ...
     * Sets domain
     *
     * @param string|null $domain Customer domain.
     *
     * @return self
     */
     ...
     * Sets dateOrder
     *
     * @param \DateTime|null $dateOrder Date of Order.
     *
     * @return self
     */
     ...
     *
     * @param string|null $orderCurrencyCode Currency code.
     *
     * @return self
     */
