...
/**
 * ShipperModel Class Doc Comment
 *
 * @category Class
 * @package  Retailys
 * @author   OpenAPI Generator team
 ...
 */
class ShipperModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShipperModel';
     ...
     * Sets id
     *
     * @param int|null $id Shipper Identifier.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Shipper name.
     *
     * @return self
     */
